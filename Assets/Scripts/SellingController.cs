...
public class SellingController : MonoBehaviour
{
    ...
    //Sound FX
    public AudioClip appearSound; // звук при по€влении облачка над персонажей.
    public AudioClip disappearSound; //звук при пропадании облачка над персонажами.
    public AudioClip clickSound; // звук нажати€ на кнопки.
    public AudioClip selectSound; //звук выбора продукта в инвентаре.
    public AudioClip moneySound; //звук начислени€ денег за заказ.
